...
\usepackage{acl}%
%
\title{Sri Lanka Document Datasets: A Large{-}Scale, Multilingual Resource for Law, News, and Policy (v2025{-}10{-}13{-}2319)}%
...
\section{Datasets}%
\label{sec:Datasets}%
As of v2025-10-13-2319, Sri Lanka Document Datasets
...
\item%
\textbf{News}: A collection of news documents.\textit{ 80,654 documents, 1.2 GB, from 2021{-}09{-}12 to 2025{-}10{-}13.} Source: multiple sources. Dataset: \href{https://github.com/nuuuwan/lk\_news/tree/data/data/lk\_news}{lk\_news}.%
\item%
